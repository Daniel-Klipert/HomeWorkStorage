...
public class HomeWork5 {
    ...
    */
    ...
    public static class Person  {
       ...
       private int health = 50;// Напиши здесь свою реализацию класса Person
        ...
        public void takeDamage(Integer damage) throws Exception, PersonDead {
            if (damage < 0) throw new Exception(); else health = health - (damage - protection);
            if (health < 0) {
                health = 0;
    ...
    public static class Mage extends Person{
        ...
        public void takeDamage(Integer damage) throws Exception, PersonDead {
            ...
            else super.health = super.health - (damage - super.protection - super.health % 10);
            if (super.health < 0)  {
                super.health = 0;
                throw new PersonDead("");
            }
    ...
    public static class Archer extends Person{
        ...
        public void takeDamage(Integer damage) throws Exception, PersonDead{
            if (damage < 0) throw new Exception(); else super.health = super.health - (damage - super.protection + super.health % 10);
            if (super.health < 0)  {
                super.health = 0;
                throw new PersonDead("");
            }
